...
@Component({
  selector: 'app-swipeable-section',
  templateUrl: './swipeable-section.component.html',
  styleUrls: ['./swipeable-section.component.css']
})
export class SwipeableSectionComponent implements OnInit {
